                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Agregar resultado de laboratorio</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Agregar Resultados</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4" class="col-form-label">Enfermadad paciente</label>
                                                ...
                                                <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Test laboratorio</label>
                                                        <textarea required="required"  type="text" class="form-control" name="lab_pat_tests" id="editor"><?php echo $row->lab_pat_tests;?></textarea>
                                                </div>

                                                <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Resultados de laboratorio</label>
                                                        <textarea required="required"   type="text" class="form-control" name="lab_pat_results" id="editor1"></textarea>
                                                </div>

                                                <button type="submit" name="add_patient_lab_result" class="ladda-button btn btn-success" data-style="expand-right">Agregar resultados de laboratorio</button>
