                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Numero empleado :</strong> <span class="ml-2"><?php echo $row->doc_number;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Email empleado :</strong> <span class="ml-2"><?php echo $row->doc_email;?></span></p>
