                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Generar pagos</li>
                                            </ol>
                                        </div>
                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="float-right">
                                                <h4 class="m-0 d-print-none"><?php echo $row->pay_doc_name;?> Pagos</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 offset-md-2">
                                                <div class="mt-3 float-right">
                                                    <p class="m-b-10"><strong>Generar fecha : </strong> <span class="float-right"> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo date("d-m-Y - h:m:s", strtotime($mysqlDateTime));?> </span></p>
                                                    <p class="m-b-10"><strong>Estados de pago : </strong> <span class="float-right"><span class="badge badge-success"><?php echo $row->pay_status;?></span></span></p>
                                                    <p class="m-b-10"><strong>Numero de pago : </strong> <span class="float-right"><?php echo $row->pay_number;?></span></p>
                                                    <p class="m-b-10"><strong>ID empleado : </strong> <span class="float-right"><?php echo $row->pay_doc_number;?></span></p>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table mt-4 table-centered table-bordered">
                                                        ...
                                                        <tr><th>#</th>
                                                            ...
                                                            <th style="width: 10%" class="text-right">Total impuesto</th>
                                                        </tr></thead>
                                                        <tbody>
                                                        <tr>
                                                            <td><?php echo $cnt;?></td>
                                                            <td>
                                                                ...
                                                                ?>
                                                            <td>S/<?php echo $row->pay_emp_salary;?></td>
                                                            <td>18%</td>
                                                            
                                                            <td class="text-right">S/ <?php echo $taxable_salary;?></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="float-right">
                                                    <p><b>Sub-total:</b> <span class="float-right">S/. <?php echo $row->pay_emp_salary;?></span></p>
                                                    <p><b>Impuesto (18%) :</b> <span class="float-right"> &nbsp;&nbsp;&nbsp; <?php echo $taxable_salary;?> </span></p>
                                                    <h3>S/.<?php echo $total_salary;?></h3>
                                                </div>
