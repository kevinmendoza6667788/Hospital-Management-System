                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <hr>
                                                    <h3 class="text-danger">Edad : <?php echo $row->pres_pat_age;?> Years</h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Numero de paciente : <?php echo $row->pres_pat_number;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Categoria paciente : <?php echo $row->pres_pat_type;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Enfermedad paciente : <?php echo $row->pres_pat_ailment;?></h3>
                                                    <hr>
