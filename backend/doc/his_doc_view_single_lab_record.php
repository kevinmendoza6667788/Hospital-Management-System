                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Registros de Laboratorio</a></li>
                                                <li class="breadcrumb-item active">Ver registros</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title"><?php echo $row->lab_number;?> Registro de paciente</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Nombre paciente : <?php echo $row->lab_pat_name;?></h2>
                                                    <hr>
                                                    <h3 class="text-danger ">ID paciente : <?php echo $row->lab_pat_number;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Enfermedad paciente : <?php echo $row->lab_pat_ailment;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Fecha de registros : <?php echo date("d/m/Y - h:m:s", strtotime($mysqlDateTime));?></h3>
                                                    <hr>
                                                    <h2 class="align-centre">Test de laboratorio</h2>
                                                    <hr>
                                                    <p class="text-muted mb-4">
                                                        <?php echo $row->lab_pat_tests;?>
                                                    </p>
                                                    <hr>
                                                    <h2 class="align-centre">Resultados de laboratorio</h2>
                                                    <p class="text-muted mb-4">
