                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="his_doc_dashboard.php">Panel de Control</P></a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Completar campos</h4>
                                        <!--Add Patient Form-->
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Primer nombre</label>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Fecha de cumpleaños</label>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputCity" class="col-form-label">Numero de telefono</label>
                                                    <input required="required" type="text" value="<?php echo $row->pat_phone;?>" name="pat_phone" class="form-control" id="inputCity">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="inputCity" class="col-form-label">Direccion</label>
                                                ...
                                                <div class="form-group col-md-6" style="display:none">
                                                    ...
                                                    <select id="inputState" required="required" name="pat_type" class="form-control">
                                                        ...
                                                        <option>Paciente/entrada</option>
                                                        <option>Paciente/salida</option>
                                                    </select>
                                                </div>
                                            </div>

                                            <button type="submit" name="discharge_patient" class="ladda-button btn btn-success" data-style="expand-right">Descargar</button>
