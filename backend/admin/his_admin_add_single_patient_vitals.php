	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_vitals']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Se agregaron signos vitales del paciente";
			}
			else {
                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                Capturar signos vitales</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Captura <?php echo $row->pat_fname;?> <?php echo $row->pat_lname;?> vitales</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="inputEmail4" class="col-form-label">Número de paciente</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-2" style="display:none">
                                                        ...
                                                        ?>
                                                        <label for="inputZip" class="col-form-label">Número vital</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="inputPassword4" class="col-form-label">
                                                        Pulso/latido del corazón del paciente BPM</label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="inputPassword4" class="col-form-label">Presión arterial del paciente mmHg</label>
