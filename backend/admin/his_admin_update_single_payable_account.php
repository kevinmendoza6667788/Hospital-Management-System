	...
	include('assets/inc/config.php');
		if(isset($_POST['update_acc']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Detalles de cuenta por pagar actualizados";
			}
			else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            Contabilidad</a></li>
                                            <li class="breadcrumb-item active">Administrar cuenta por pagar</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">
                                    Detalles de la cuenta por pagar</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group ">
                                                    <label for="inputPassword4" class="col-form-label">Descripción de cuenta</label>
                                            ...
                                            <button type="submit" name="update_acc" class="ladda-button btn btn-warning" data-style="expand-right">Actualizar cuenta</button>
