                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Equipos #<?php echo $row->eqp_code;?> Detalles</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <hr>
                                                    <h4 class="text-danger">Proveedor equipo: <?php echo $row->eqp_vendor;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Codigo de barras equipo: <?php echo $row->eqp_code;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Equipo disponible : <?php echo $row->eqp_qty;?></h4>
                                                    <hr>
