	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_lab_result']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Se agregaron resultados de laboratorio del paciente";
			}
			else {
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">
                                        Agregar resultado de laboratorio</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="header-title">Llene todos los campos
                                            </h4>
                                            <!--Add Patient Form-->
                                            <form method="post">
                                                <div class="form-row">
                                                ...
                                                <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Pruebas de laboratorio</label>
                                                        <textarea required="required"  type="text" class="form-control" name="lab_pat_tests" id="editor"><?php echo $row->lab_pat_tests;?></textarea>
                                                </div>

                                                <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Resultado de laboratorio</label>
                                                        <textarea required="required"   type="text" class="form-control" name="lab_pat_results" id="editor1"></textarea>
                                                </div>

                                                <button type="submit" name="add_patient_lab_result" class="ladda-button btn btn-success" data-style="expand-right">Agregar resultado de laboratorio</button>
