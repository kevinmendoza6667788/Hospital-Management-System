                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-left mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Fecha de cumpleaños:</strong> <span class="ml-2"><?php echo $row->pat_dob;?></span></p>
                                        ...
                                        <hr>
                                        <p class="text-muted mb-2 font-13"><strong>Fecha de registro :</strong> <span class="ml-2"><?php echo date("d/m/Y - h:m", strtotime($mysqlDateTime));?></span></p>
                                        <hr>
