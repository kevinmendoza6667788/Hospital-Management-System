                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Ver registros medicos</li>
                                            </ol>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Nombre : <?php echo $row->mdr_pat_name;?></h2>
                                                    <hr>
                                                    <h3 class="text-danger">Edad : <?php echo $row->mdr_pat_age;?> Years</h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Numero de paciente : <?php echo $row->mdr_pat_number;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Enfermedad de paciente : <?php echo $row->mdr_pat_ailment;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Fecha registro : <?php echo date("d/m/Y - h:m:s", strtotime($mysqlDateTime));?></h3>
                                                    <hr>
                                                    <h2 class="align-centre">Preescripcion</h2>
                                                    <hr>
