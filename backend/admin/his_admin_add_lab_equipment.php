	...
	include('assets/inc/config.php');
        ...
        
        {
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Equipo de laboratorio agregado";
			}
			else {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">
                                    Agregar equipo de laboratorio</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4" style="display:none">
                                                    <label for="inputPassword4" class="col-form-label">Departamentos de equipos</label>
                                            ...
                                            <div class="form-group" style="style:display-none">
                                                ...
                                                Descripción de la categoría farmacéutica</label>
                                                <textarea required="required" type="text" class="form-control" name="eqp_desc" id="editor"></textarea>
                                            </div>

                                           <button type="submit" name="add_equipments" class="ladda-button btn btn-success" data-style="expand-right">Agregar equipo</button>
