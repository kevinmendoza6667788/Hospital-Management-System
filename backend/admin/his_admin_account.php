                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title"><?php echo $row->ad_fname;?> <?php echo $row->ad_lname;?>'s Perfil</h4>
                                    </div>
                                </div>
                            </div>
                            <!-- end page title -->
                                ...
                                <div class="col-lg-4 col-xl-4">
                                    <div class="card-box text-center">
                                        ...
                                        <div class="text-left mt-3">
                                            <p class="text-muted mb-2 font-13"><strong>Nombre completo :</strong> <span class="ml-2"><?php echo $row->ad_fname;?> <?php echo $row->ad_lname;?></span></p>
                                            <p class="text-muted mb-2 font-13"><strong>Correo :</strong> <span class="ml-2 "><?php echo $row->ad_email;?></span></p>
                                        </div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="useremail">Confirmar contraseña</label>
                                                        <input type="password" class="form-control" id="useremail" placeholder="Confirm New Password">
                                                    </div>

                                                    <div class="text-right">
                                                        <button type="submit" name="update_pwd" class="btn btn-success waves-effect waves-light mt-2"><i class="mdi mdi-content-save"></i> Actualiza contraseña</button>
                                                    </div>
                                                </form>
                                            </div>
