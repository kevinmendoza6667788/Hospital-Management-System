                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <hr>
                                                    <h3 class="text-danger ">Numero paciente : <?php echo $row->lab_pat_number;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Enfermedad paciente : <?php echo $row->lab_pat_ailment;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Fecha registro : <?php echo date("d/m/Y - h:m:s", strtotime($mysqlDateTime));?></h3>
                                                    <hr>
